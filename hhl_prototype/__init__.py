...
"""
Linear solvers (:mod:`quantum_linear_solvers.linear_solvers`)
=========================================================
It  contains classical and quantum algorithms to solve systems of linear equations such as
:class:`~quantum_linear_solvers.linear_solvers.HHL`.
...
.. currentmodule:: quantum_linear_solvers.linear_solvers
